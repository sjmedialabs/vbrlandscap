    ...
    <div className="flex h-screen bg-[#f5f7f0]">
      ...
      <main className="flex-1 overflow-y-auto px-8 py-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-[#666]">Manage all website content from here</p>
        </div>
          ...
          <>
            <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-xl border border-[#e5e5e5] bg-white p-5">
                ...
                <p className="text-2xl font-bold text-[#1a1a1a]">{sectionCount}</p>
              ...
              <div className="rounded-xl border border-[#e5e5e5] bg-white p-5">
                ...
                <p className="text-2xl font-bold text-[#1a1a1a]">{hasSections ? "Connected" : "Not Seeded"}</p>
              ...
              <div className="rounded-xl border border-[#e5e5e5] bg-white p-5">
                ...
                <a href="/" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-[#2d6a2e] hover:underline">
                  View Live Site
                </a>
            ...
            {!hasSections && (
              <div className="rounded-xl border border-yellow-200 bg-yellow-50 p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-yellow-800">Database Not Seeded</p>
                    <p className="mt-1 text-sm text-yellow-700">
                      Click the button below to populate the database with default content.
                    </p>
                    <SeedButton />
                  </div>
                </div>
